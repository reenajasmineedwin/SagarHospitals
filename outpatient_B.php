...
<body>
    ...
    <div class="page-wrapper p-t-20 p-b-50 " style="background-color: #2a55b1">
        ...
        <div class="wrapper wrapper--w900">
            ...
            <div class="card card-6">
                <div class="card-heading">
                    ...
                    <h2 class="title">Out Patient Feedback Form Banashankari </h2>
                </div>
                <div class="card-body">
                   <form action="outpatient_B.php" method="post">
                               ...
                               <div class="value">
                                <select class="input--style-6" style="margin-top: 2px; width:165px; height:38px;" name="branch" id="category-dropdown">
                                      <option value="">Select Branch</option>
                                        <?php
                                        $result = mysqli_query($con, "SELECT * FROM  Doctor_Data_B where parent_id = 0");
